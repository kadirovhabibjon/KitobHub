...
check_container_running "tools-service"
...
check_json_endpoint "Tools health via gateway" "http://localhost:8088/api/tools/health"
check_json_endpoint "Currency API via gateway" "http://localhost:8088/api/tools/currency/rates?currency=USD"
check_json_endpoint "Weather API via gateway" "http://localhost:8088/api/tools/weather/tashkent"
